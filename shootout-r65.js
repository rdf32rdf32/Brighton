// Albion Fan Hub r65 penalty game
(() => {
  "use strict";
  ...
  // r65: Brighton can deliberately aim narrowly wide or high. The visible target is
  ...
  const albionTakers = window.ALBION_DATA_R65?.penaltyTakers || [];
  const palaceTakers = window.ALBION_DATA_R65?.palaceTakers || [];
