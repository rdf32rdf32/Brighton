...
window.ALBION_CONTENT = {
  ...
  freshness: {
    fixtures: "29 July 2026",
    squad: "29 July 2026",
    travel: "29 July 2026",
    history: "29 July 2026",
  },
  nextMatch: {
  ...
  squad: [
    ...
    { name: "Luka Vušković", position: "Defender" },
  ...
  playerProfiles: [
    { name: "Bart Verbruggen", position: "Goalkeeper", role: "Goalkeeper", number: null, nationality: "Netherlands", initials: "BV", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Jason Steele", position: "Goalkeeper", role: "Goalkeeper", number: null, nationality: "England", initials: "JS", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Tom McGill", position: "Goalkeeper", role: "Goalkeeper", number: null, nationality: "Canada", initials: "TM", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Carl Rushworth", position: "Goalkeeper", role: "Goalkeeper", number: null, nationality: "England", initials: "CR", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Pascal Struijk", position: "Defender", role: "Centre-back", number: null, nationality: "Netherlands", initials: "PS", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Costinha", position: "Defender", role: "Right-back", number: null, nationality: "Portugal", initials: "CO", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Michael Svoboda", position: "Defender", role: "Centre-back", number: null, nationality: "Austria", initials: "MS", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Luka Vušković", position: "Defender", role: "Centre-back", number: null, nationality: "Croatia", initials: "LV", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Igor Julio", position: "Defender", role: "Centre-back", number: null, nationality: "Brazil", initials: "IJ", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Lewis Dunk", position: "Defender", role: "Centre-back", number: null, nationality: "England", initials: "LD", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Eiran Cashin", position: "Defender", role: "Centre-back", number: null, nationality: "Ireland", initials: "EC", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Olivier Boscagli", position: "Defender", role: "Centre-back / left-back", number: null, nationality: "France", initials: "OB", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Ferdi Kadioglu", position: "Defender", role: "Full-back / wing-back", number: null, nationality: "Turkey", initials: "FK", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Maxim De Cuyper", position: "Defender", role: "Left-back / wing-back", number: null, nationality: "Belgium", initials: "MD", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Amario Cozier-Duberry", position: "Midfielder", role: "Wide midfielder", number: null, nationality: "England", initials: "AC", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Jack Hinshelwood", position: "Midfielder", role: "Central midfielder / full-back", number: null, nationality: "England", initials: "JH", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Carlos Baleba", position: "Midfielder", role: "Central midfielder", number: null, nationality: "Cameroon", initials: "CB", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Kaoru Mitoma", position: "Midfielder", role: "Left winger", number: null, nationality: "Japan", initials: "KM", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Diego Gómez", position: "Midfielder", role: "Central midfielder", number: null, nationality: "Paraguay", initials: "DG", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Yasin Ayari", position: "Midfielder", role: "Central midfielder", number: null, nationality: "Sweden", initials: "YA", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Mats Wieffer", position: "Midfielder", role: "Defensive midfielder", number: null, nationality: "Netherlands", initials: "MW", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Pascal Groß", position: "Midfielder", role: "Central midfielder", number: null, nationality: "Germany", initials: "PG", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Matt O'Riley", position: "Midfielder", role: "Attacking midfielder", number: null, nationality: "Denmark", initials: "MO", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Malick Yalcouyé", position: "Midfielder", role: "Central midfielder", number: null, nationality: "Côte d’Ivoire", initials: "MY", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Facundo Buonanotte", position: "Midfielder", role: "Attacking midfielder", number: null, nationality: "Argentina", initials: "FB", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Ibrahim Osman", position: "Forward", role: "Winger", number: null, nationality: "Ghana", initials: "IO", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Zadok Yohanna", position: "Forward", role: "Forward", number: null, nationality: "Nigeria", initials: "ZY", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Stefanos Tzimas", position: "Forward", role: "Centre-forward", number: null, nationality: "Greece", initials: "ST", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Georginio Rutter", position: "Forward", role: "Forward / attacking midfielder", number: null, nationality: "France", initials: "GR", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Yankuba Minteh", position: "Forward", role: "Right winger", number: null, nationality: "Gambia", initials: "YM", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Tom Watson", position: "Forward", role: "Wide forward", number: null, nationality: "England", initials: "TW", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Danny Welbeck", position: "Forward", role: "Centre-forward", number: null, nationality: "England", initials: "DW", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Charalampos Kostoulas", position: "Forward", role: "Forward", number: null, nationality: "Greece", initials: "CK", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Evan Ferguson", position: "Forward", role: "Centre-forward", number: null, nationality: "Ireland", initials: "EF", summary: "Included in this provisional first-team squad snapshot." },
    { name: "Mark O'Mahony", position: "Forward", role: "Centre-forward", number: null, nationality: "Ireland", initials: "MM", summary: "Included in this provisional first-team squad snapshot." },
  ],
  fixtures: [
    {
      date: "23 Aug 2026",
...
(() => {
  ...
  ui();
  initialiseQuiz();
  // Professional release: retire earlier PWA workers and caches.
  if ("serviceWorker" in navigator) {
    window.addEventListener("load", () => {
      ...
      if ("caches" in window) caches.keys().then((keys) => Promise.all(keys.filter((key) => key.toLowerCase().includes("albion")).map((key) => caches.delete(key)))).catch(() => {});
    }, { once: true });
  }
})();
...
(() => {
  ...
  if (release) release.textContent='Release 56';
