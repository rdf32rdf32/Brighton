...
- Added keyboard navigation, clear control, mobile results and highlighted destinations.
- Reworked mobile goalkeeper controls so swipes can start and finish anywhere across the penalty pitch.
- Added tap-left, tap-centre and tap-right saves, pointer capture, swipe trail and optional haptic confirmation.
- Increased goalkeeper size on phones and improved positioning.
- Hid the fixed mobile navigation and floating controls while playing or viewing search results, giving the game and results more room.
