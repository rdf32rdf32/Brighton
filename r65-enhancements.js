// Albion Fan Hub r65 site-wide finishing pass.
(() => {
  "use strict";
  const $ = (id) => document.getElementById(id);
  document.body.dataset.release = "r65";
  ...
  // Quietly retire every old offline worker/cache. r65 behaves like a normal website.
