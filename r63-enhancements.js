// Albion Fan Hub r63 site-wide finishing pass.
(() => {
  "use strict";
  const $ = (id) => document.getElementById(id);
  document.body.dataset.release = "r63";
  ...
  // Quietly retire every old offline worker/cache. r63 behaves like a normal website.
