// Albion Fan Hub r63 penalty game
(() => {
  "use strict";
  ...
  // r63: Brighton can deliberately aim narrowly wide or high. The visible target is
  ...
  const albionTakers = window.ALBION_DATA_R63?.penaltyTakers || [];
  const palaceTakers = window.ALBION_DATA_R63?.palaceTakers || [];
